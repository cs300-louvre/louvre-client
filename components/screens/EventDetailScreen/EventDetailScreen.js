        ...
        <View
            ...
            <Card>
                ...
                <Card.Body>
                    ...
                    <Card.Rating rating={item.rating} numReviews={item.numReviews} size={15} />
                    <View
                        style={{
                            display: "flex",
                        ...
                        <View
                            ...
                            <CustomizedButton title={"Message"} backgroundColor={"#000000"} color={"#0085FF"} />
                            <CustomizedButton title={"70000VND"} />
                        </View>
                        <View
                            style={{
                                display: "flex",
