...
import usePostPost from "../../../hooks/post/usePostPost";
...
export default function AdminDetailScreen({ item }) {
  ...
  const { mutateAsync: mutatePost } = usePostPost();
  ...
  return (
    ...
    >
      ...
      >
        <MenuItem underlined onPress={() => console.log("Tickets sold/used")}>
          Tickets sold/used
        </MenuItem>
        <MenuItem underlined onPress={() => console.log("Reviews")}>
          Reviews
        </MenuItem>
        <MenuItem underlined onPress={() => console.log("Followers")}>
          Followers
        </MenuItem>
        <MenuItem
          onPress={() =>
      ...
      {item == undefined ? (
        <EventUpdatesTab eventId={event.eventId} />
      ) : (
